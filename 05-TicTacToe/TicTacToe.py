...
class Game:
    def __init__(self):
        ...
        # NOTE: code above does the same thing as "self.board = [[".", ".", "."], [".", ".", "."], [".", ".", "."]]"
    ...
    def check_for_game_over(self):
        ...
        for line in lines:
            if line == "XXX" or line == "OOO":
                self.game_is_over = True
                pygame.mixer.music.play()   # Violation of Model/View/Controller system (technique?)
...
def main():
    ...
    # DELETE ALL OF THESE TESTS LATER (but actually do NOT bc this is an example and tests are helpful for reference.
    # but delete if this were a project)
    # Tests T0D0s 1-15:
    """
    print(view_controller.game)
    view_controller.game.take_turn(1, 1) # X in the middle
    print(view_controller.game)
    view_controller.game.take_turn(0, 2) # O in top right
    print(view_controller.game)
    view_controller.game.take_turn(0, 0) # X in top left
    print(view_controller.game)
    view_controller.game.take_turn(1, 2) # O in right middle
    print(view_controller.game)
    view_controller.game.take_turn(2, 2) # X in lower right (X wins!)
    print(view_controller.game)
    """
